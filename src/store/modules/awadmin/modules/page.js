...
export default {
  ...
  state: {
    ...
    // 已经加载多标签页数据 https://github.com/aw-projects/aw-admin/issues/201
    openedLoaded: false,
    // 当前页面
    current: '',
    // 需要缓存的页面 name
  ...
  actions: {
    /**
     * @description 确认已经加载多标签页数据 https://github.com/aw-projects/aw-admin/issues/201
    ...
    openedLoad ({ state, commit, dispatch }) {
      return new Promise(async resolve => {
        // store 赋值
        const value = await dispatch('awadmin/db/get', {
          dbName: 'sys',
          path: 'page.opened',
        ...
        // 标记已经加载多标签页数据 https://github.com/aw-projects/aw-admin/issues/201
