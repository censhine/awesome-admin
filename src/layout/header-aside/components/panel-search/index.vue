<template>
  <div class="panel-search" flex="dir:top">
    <div class="panel-search__input-group" flex-box="0" flex="dir:top main:center cross:center" @click.self="handlePanelClick">
      <aw-icon-svg class="panel-search__logo" name="aw-admin-text"/>
      <el-autocomplete
        ...
        @select="handleSelect">
        <aw-panel-search-item slot-scope="{ item }" :item="item"/>
      </el-autocomplete>
...
export default {
  ...
  components: {
    'aw-panel-search-item': () => import('./components/panel-search-item/index.vue')
  },
  data () {
    return {
      searchText: '',
