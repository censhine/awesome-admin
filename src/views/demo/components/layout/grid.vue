<template>
  <aw-container type="full" class="page">
    <aw-grid-layout
      v-bind="layout"
      ...
      <aw-grid-item
        ...
        <el-card shadow="never" class="page_card">
          ...
          <template v-if="item.i === '0'">
            <div class="aw-mb">拖拽卡片调整位置</div>
            <div class="aw-mb">拖拽卡片右下角的手柄调整卡片大小</div>
            <div class="aw-mb">在控制台打印出数据变化</div>
          </template>
        </el-card>
      </aw-grid-item>
    </aw-grid-layout>
...
Vue.component('aw-grid-layout', GridLayout)
Vue.component('aw-grid-item', GridItem)
export default {
  data () {
    return {
      layout: {
