<template>
  <aw-container>
    ...
    <el-row>
      <el-col :span="12">
        <p class="aw-mt-0">属性方式</p>
        <el-input
          placeholder="请选择日期"
          suffix-icon="el-icon-date"
          v-model="input2"
          class="input-demo-200 aw-mr-10">
        </el-input>
        <el-input
          placeholder="请输入内容"
          prefix-icon="el-icon-search"
          v-model="input21"
          class="input-demo-200 aw-mt-10">
        </el-input>
      </el-col>
      <el-col :span="12">
        <p class="aw-mt-0">slot 方式</p>
        <el-input
          placeholder="请选择日期"
          v-model="input22"
          class="input-demo-200 aw-mr-10">
