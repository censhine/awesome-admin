<template>
  <aw-container>
    <aw-header title="商家进货列表"></aw-header>
    <div class="btn-group">
      <span class="btn-list"
    ...
    <el-table
      ...
      >
        <template slot-scope="scope">
        	...
        	<el-button type="text" @click="sendGoods(scope.row)"   size="mini">发货</el-button>
          ...
          <el-button type="text" style='color: red;' @click="deletes(scope.row)" size="mini">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-divider></el-divider>
