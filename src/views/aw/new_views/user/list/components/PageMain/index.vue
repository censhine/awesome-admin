    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag v-if="scope.row.has_store" type="success">有店铺</el-tag>
          <el-tag v-if="!scope.row.has_store" type="danger">没有店铺</el-tag>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-switch
            inactive-value="0"
            active-value="1"
            v-model="currentTableData[scope.$index].status"
            @change="handleSwitch(currentTableData[scope.$index].status,scope.$index)">
          </el-switch>
        </template>
      </el-table-column>
