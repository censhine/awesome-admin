<template>
  <el-form
    ...
    <el-row>
      <el-button type="primary">全部(20000)</el-button>
      <el-button>普通用户(15000)</el-button>
      <el-button>供应商(2000)</el-button>
      <el-button>商家(2500)</el-button>
      <el-button>律师(500)</el-button>
    </el-row>
